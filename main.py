...
class Comment(UserMixin, db.Model):
    ...
    #create foreign key author id in Comments table from user table
    author_id = db.Column(db.Integer, db.ForeignKey("user.id"))
    # creating user object in comments table
    comment_author = relationship("User", back_populates="comments")
    #creating a foreignkey post_id in comments table from "blog_posts" table
    post_id = db.Column(db.Integer, db.ForeignKey("blog_posts.id"))
    #create a post object in comments table
    ...
    if comment_form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            user_comment = Comment(
                text=comment_form.commentText.data,
                author_id=a_id,
                post_id=post_id
            )
            ...
            #TODO:this always return True AnonymousUserMixin error
